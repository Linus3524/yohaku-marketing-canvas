...
export const LockedPhaseCard: React.FC<LockedPhaseCardProps> = ({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 pb-12 mt-8 opacity-50 select-none">
      <div className="bg-white/30 rounded-3xl p-8 border border-slate-200/30 backdrop-blur-xs shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6">
